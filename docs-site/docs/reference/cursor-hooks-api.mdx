...
The hooks that **can** block all cover actions, not response text. This project implements all of them — see [Optional Hooks](../features/optional-hooks):
